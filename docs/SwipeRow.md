...
| `onSwipeValueChange` | Callback invoked any time the translateX value of the row changes | `func` | `{ swipeData: { value: number, direction: 'left' | 'right', isOpen: bool , key: string }`
